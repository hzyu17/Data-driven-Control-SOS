...
if strcmp(experiment, 'L1-data driven vdp')
    ...
    option.data_driven_option.type = 'data_driven'; % 'data_driven' and 'model_based'
...
polynomials_definition(option); 

%% gEDMD
if strcmp(option.data_driven_option.type, 'data_driven')
    gEDMD_filename = sampling_gEDMD(option);
else
    gEDMD_filename = '';
end
